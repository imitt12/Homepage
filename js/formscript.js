...
function displayPerson(event) {
	...
	var html = "<p>Name: " + Person.name + ".</p><p>Password: " + Person.secretData + ".</p><p>Short bio: " + Person.bio + "</p><p>Who is a[n]: " + Person.gender + ".</p><p>With: " + Person.limbs.join(", ") + ".</p><p>Who wants: " + Person.car + ".</p>";
